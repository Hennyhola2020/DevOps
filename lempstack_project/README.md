...
![ssh](./img/ssh_i.jpg)
![ssh](./img/aws_instane.jpg)

# Installing the Nginx Web Server
![nginx](./img/nginx_install.jpg)

![nginx](./img/status_nginx.jpg)
...
![mysql](./img/install_mysql_server.jpg)
...
![sec](./img/mysql_secure.jpg)
![validate](./img/password_plugin.jpg)

### We can go ahead to view the databases available to us
![db](./img/show_database.jpg)

### Adding a database to existing ones
![db](./img/Database.jpg)![db](./img/show_database.jpg)
...
![user](./img/example_user.jpg)
![user](./img/mysql_example_user__-p.jpg)


### This will give the example_user user full privileges over the example_database database, while preventing this user from creating or modifying other databases on your server
![user](./img/grant_all.jpg)
